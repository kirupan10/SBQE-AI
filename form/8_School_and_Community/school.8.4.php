<?php include "../backend/function_loggedin.php";
    ...
    if(isset($_POST['submit'])){
        ...
        if ($data1 != "" && $data2 != "" && $data3 != ""  ){
            ...
            $sql_insert_datarow_1 = "INSERT INTO school_community_main (School_ID,Activity_Number,Marks,Session_Name) VALUE ('{$_SESSION['school_id']}','8.4.1',$data1,'{$_SESSION['username']}')";

            $sql_insert_datarow_2 = "INSERT INTO school_community_main (School_ID,Activity_Number,Marks,Session_Name) VALUE ('{$_SESSION['school_id']}','8.4.2',$data2,'{$_SESSION['username']}')";

            $sql_insert_datarow_3 = "INSERT INTO school_community_main (School_ID,Activity_Number,Marks,Session_Name) VALUE ('{$_SESSION['school_id']}','8.4.3',$data3,'{$_SESSION['username']}')";
...
$marks1 = "";
$sql = "SELECT  Marks FROM school_community_main WHERE Activity_Number ='8.4.1' && School_ID ='{$_SESSION['school_id']}'  LIMIT 1 ";
...
$marks2 = "";
$sql = "SELECT  Marks FROM school_community_main WHERE Activity_Number ='8.4.2' && School_ID ='{$_SESSION['school_id']}'  LIMIT 1 ";
$result = $con->query($sql);
...
$marks3 = "";
$sql = "SELECT  Marks FROM school_community_main WHERE Activity_Number ='8.4.3' && School_ID ='{$_SESSION['school_id']}'  LIMIT 1 ";
$result = $con->query($sql);
...
<p>06 marks - Excellent </p>
  ...
  <tr class="active-row" >
    <td>8.4.1</td>
    <td>  The school makes effective use of different communication modes 
(notice boards/ internal notice books/ teacher – parent record books)</td>
    ...
    <tr class="active-row" >
    <td>8.4.2</td>
    <td>The school takes effective steps to make the community aware of 
the special programmes implemented in the school and a good methods 
are implemented to gather ideas from the community (suggestion boxes, 
questionnaires)</td>
  ...
  <tr class="active-row" >
    <td>8.4.3</td>
    <td>There is an effective system for meeting the principal / teachers, 
and records of community needs and details of feasible solutions are 
accessible</td>
    ...
    <?php $_SESSION["school_8.4"] = $total_marks; ?>
    <?php echo "Marks Total"."  ". $_SESSION["school_8.4"]; ?>
  </tr>
...
<a  style="float:right; color: black"; href= "school.8.5.php" >Go to next page</a>
<a  style="float:left; color: black;" href= "school.8.3.php" >Go to previous page</a>    
