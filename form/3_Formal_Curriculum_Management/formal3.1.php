<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if ($data1 != "" && $data2 != "" ){
            $sql_insert_datarow_1 = "INSERT INTO formal_curriculum_management_main (School_ID,Activity_Number,Marks,Session_Name) VALUE ('{$_SESSION['school_id']}','3.1.1',$data1,'{$_SESSION['username']}')";

            $sql_insert_datarow_2 = "INSERT INTO formal_curriculum_management_main (School_ID,Activity_Number,Marks,Session_Name) VALUE ('{$_SESSION['school_id']}','3.1.2',$data2,'{$_SESSION['username']}')";
...
$sql = "SELECT  Marks FROM formal_curriculum_management_main WHERE Activity_Number ='3.1.1' && School_ID ='{$_SESSION['school_id']}'  LIMIT 1 ";
...
$sql = "SELECT  Marks FROM formal_curriculum_management_main WHERE Activity_Number ='3.1.2' && School_ID ='{$_SESSION['school_id']}' order by Formal_Curriculum_Management_ID desc LIMIT 1 ";
$result = $con->query($sql);
...
<p>06 marks - Excellent </p>
  ...
  <tr class="active-row" >
    <td>3.1.1</td>
    <td>Displaying national educational goals and basic 
competencies in the school premises and the school 
community has been made aware of the national goals and basic 
competencies</td>
    ...
    <tr class="active-row" >
    <td>3.1.2</td>
    <td> Preparation and implementation of the annual curriculum 
plan ensuring the achievement of the national goals and basic 
competencies</td>
