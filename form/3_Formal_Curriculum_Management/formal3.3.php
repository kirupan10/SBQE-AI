...
<p>06 marks - Excellent </p>
  ...
  <tr class="active-row" >
    <td>3.3.1</td>
    <td> Implementation of the programme to identify the 
...
and implement a monitoring programme in this regard</td>
    ...
    <?php $_SESSION["formal3_3"] = $total_marks; ?>
    <?php echo "Marks Total"."  ". $_SESSION["formal3_3"]; ?>
  </tr>
...
<a  style="float:right; color: black"; href="formal3.4.php" >Go to next page</a>
<a  style="float:left; color: black;" href="formal3.2.php" >Go to previous page</a>  
