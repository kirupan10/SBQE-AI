<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        if ($data1 != "" && $data2 != "" && $data3 != ""  ){
            ...
            $sql_insert_datarow_1 = "INSERT INTO formal_curriculum_management_main (School_ID,Activity_Number,Marks,Session_Name) VALUE ('{$_SESSION['school_id']}','3.4.1',$data1,'{$_SESSION['username']}')";

            $sql_insert_datarow_2 = "INSERT INTO formal_curriculum_management_main (School_ID,Activity_Number,Marks,Session_Name) VALUE ('{$_SESSION['school_id']}','3.4.2',$data2,'{$_SESSION['username']}')";

            $sql_insert_datarow_3 = "INSERT INTO formal_curriculum_management_main (School_ID,Activity_Number,Marks,Session_Name) VALUE ('{$_SESSION['school_id']}','3.4.3',$data3,'{$_SESSION['username']}')";
...
$marks1 = "";
$sql = "SELECT  Marks FROM formal_curriculum_management_main WHERE Activity_Number ='3.4.1' && School_ID ='{$_SESSION['school_id']}'  LIMIT 1 ";
...
$marks2 = "";
$sql = "SELECT  Marks FROM formal_curriculum_management_main WHERE Activity_Number ='3.4.2' && School_ID ='{$_SESSION['school_id']}'  LIMIT 1 ";
$result = $con->query($sql);
...
$marks3 = "";
$sql = "SELECT  Marks FROM formal_curriculum_management_main WHERE Activity_Number ='3.4.3' && School_ID ='{$_SESSION['school_id']}'  LIMIT 1 ";
$result = $con->query($sql);
...
<p>06 marks - Excellent </p>
  ...
  <tr class="active-row" >
    <td>3.4.1</td>
    <td> Maintenance of space for wall paper and creation boards 
and keeping them up dated</td>
    ...
    <tr class="active-row" >
    <td>3.4.2</td>
    <td> Protection and the safety of the equipment and the facilities 
of the classrooms and keeping these up-to-date</td>
    ...
    <tr class="active-row" >
    <td>3.4.3</td>
    <td>Planning of specific places in the class room for various 
activities using these and ensuring easy access to them for 
activities (work table, book corner, class library)</td>
    ...
    <?php $_SESSION["formal3_4"] = $total_marks; ?>
    <?php echo "Marks Total"."  ". $_SESSION["formal3_4"]; ?>
  </tr>
...
<a  style="float:right; color: black"; href="formal3.5.php" >Go to next page</a>
<a  style="float:left; color: black;" href="formal3.3.php" >Go to previous page</a>  
