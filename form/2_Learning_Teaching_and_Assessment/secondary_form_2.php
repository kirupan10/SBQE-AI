...
<!--                                  You can add classes for different colours on the next element -->
 ...
 <?php                                        if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) { $i++;?>
                                        ...
                                        <li onclick="location.href='function_selection.php?function=<?php echo $i; ?>';"><a href=""> <?php echo "". $row["Activity"]. " : "."". $row["Indicators"]. "<br>"; }  // The value we usually set is the primary key 
                                         ?></a></li>
