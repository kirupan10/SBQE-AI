<?php session_start();
    ...
    if(isset($_POST['submit'])){
        ...
        if ($data1 != "" && $data2 != "" && $data3 != ""  ){
            ...
            $sql_insert_datarow_1 = "INSERT INTO student_welfare_main (School_ID,Activity_Number,Marks,Session_Name) VALUE ('{$_SESSION['school_id']}','5.7.1',$data1,'{$_SESSION['username']}')";

            $sql_insert_datarow_2 = "INSERT INTO student_welfare_main (School_ID,Activity_Number,Marks,Session_Name) VALUE ('{$_SESSION['school_id']}','5.7.2',$data2,'{$_SESSION['username']}')";

            $sql_insert_datarow_3 = "INSERT INTO student_welfare_main (School_ID,Activity_Number,Marks,Session_Name) VALUE ('{$_SESSION['school_id']}','5.7.3',$data3,'{$_SESSION['username']}')";
...
$marks1 = "";
$sql = "SELECT  Marks FROM student_welfare_main WHERE Activity_Number ='5.7.1' && School_ID ='{$_SESSION['school_id']}' order by Student_Welfare_ID DESC LIMIT 1 ";
...
$marks2 = "";
$sql = "SELECT  Marks FROM student_welfare_main WHERE Activity_Number ='5.7.2' && School_ID ='{$_SESSION['school_id']}'  LIMIT 1 ";
$result = $con->query($sql);
...
$marks3 = "";
$sql = "SELECT  Marks FROM student_welfare_main WHERE Activity_Number ='5.7.3' && School_ID ='{$_SESSION['school_id']}'  LIMIT 1 ";
$result = $con->query($sql);
...
whenever necessary</td>
    ...
    <?php $_SESSION["walfare_total_5_7"] = $total_marks; ?>
    <?php echo "Marks Total"."  ". $_SESSION["walfare_total_5_7"]; ?>
...
<a  style="float:right; color: black"; href="walfare5.8.php" >Go to next page</a>
<a  style="float:left; color: black;" href="walfare5.6.php" >Go to previous page</a>
</form>
