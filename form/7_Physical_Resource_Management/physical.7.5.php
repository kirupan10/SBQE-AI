<?php include "../backend/function_loggedin.php";
    ...
    if(isset($_POST['submit'])){
        ...
        if ($data1 != "" && $data2 != "" && $data3 != ""  ){
            ...
            $sql_insert_datarow_1 = "INSERT INTO physical_resource_management_main (School_ID,Activity_Number,Marks,Session_Name) VALUE ('{$_SESSION['school_id']}','7.5.1',$data1,'{$_SESSION['username']}')";

            $sql_insert_datarow_2 = "INSERT INTO physical_resource_management_main (School_ID,Activity_Number,Marks,Session_Name) VALUE ('{$_SESSION['school_id']}','7.5.2',$data2,'{$_SESSION['username']}')";

            $sql_insert_datarow_3 = "INSERT INTO physical_resource_management_main (School_ID,Activity_Number,Marks,Session_Name) VALUE ('{$_SESSION['school_id']}','7.5.3',$data3,'{$_SESSION['username']}')";
...
Table – 1.2.2.2</P>
  ...
  <tr class="active-row" >
    <td>7.5.1</td>
    <td>     Laboratories are maintained in a clean and attractive manner and 
productive use is made of these</td>
    ...
    <tr class="active-row" >
    <td>7.5.2</td>
    <td>All chemicals and equipment are properly labeled, kept securely 
and safely and used effectively</td>
   ...
   <tr class="active-row" >
    <td>7.5.3</td>
    <td> A systematic timetable is in place for the use of laboratories 
covering all the grades, including use for preparatory work</td>
