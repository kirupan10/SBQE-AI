<?php session_start();
    ...
    if(isset($_POST['submit'])){
        ...
        if ($data1 != "" && $data2 != "" ){
            $sql_insert_datarow_1 = "INSERT INTO leadership_management_main (School_ID,Activity_Number,Marks,Session_Name) VALUE ('{$_SESSION['school_id']}','6.6.1',$data1,'{$_SESSION['username']}')";

            $sql_insert_datarow_2 = "INSERT INTO leadership_management_main (School_ID,Activity_Number,Marks,Session_Name) VALUE ('{$_SESSION['school_id']}','6.6.2',$data2,'{$_SESSION['username']}')";
...
Table – 1.2.2.2</P>
  ...
  <tr class="active-row" >
    <td>6.6.1</td>
    <td> A systematic programme is maintained for starting and ending of the 
school day (religious activities and other programmes…)</td>
    ...
    <tr class="active-row" >
    <td>6.6.2</td>
    <td> The morning health programme is implemented consistently and 
teachers and students participate</td>
