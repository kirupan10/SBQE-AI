<?php  
    ...
    if(isset($_POST['submit'])){
        ...
        if ($data1 != "" && $data2 != "" ){
            $sql_insert_datarow_1 = "INSERT INTO leadership_management_main (School_ID,Activity_Number,Marks,Session_Name) VALUE ('{$_SESSION['school_id']}','6.11.1',$data1,'{$_SESSION['username']}')";

            $sql_insert_datarow_2 = "INSERT INTO leadership_management_main (School_ID,Activity_Number,Marks,Session_Name) VALUE ('{$_SESSION['school_id']}','6.11.2',$data2,'{$_SESSION['username']}')";
...
Table – 1.2.2.2</P>
  ...
  <tr class="active-row" >
    <td>6.11.1</td>
    <td>  Requirements of the school for academic and non academic staff, 
taking account of deficiencies and excesses according to the circular are 
recorded and the relevant authorities are informed</td>
    ...
    <tr class="active-row" >
    <td>6.11.2</td>
    <td>   The expected duties of academic and non-academic staff are set out 
in writing and a methodology is implemented consistently for supervising 
the duties</td>
