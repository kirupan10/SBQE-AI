<?php  
    ...
    if(isset($_POST['submit'])){
        ...
        if ($data1 != "" && $data2 != "" && $data3 != "" && $data4 != ""  ){
            ...
            $sql_insert_datarow_1 = "INSERT INTO leadership_management_main (School_ID,Activity_Number,Marks,Session_Name) VALUE ('{$_SESSION['school_id']}','6.8.1',$data1,'{$_SESSION['username']}')";

            $sql_insert_datarow_2 = "INSERT INTO leadership_management_main (School_ID,Activity_Number,Marks,Session_Name) VALUE ('{$_SESSION['school_id']}','6.8.2',$data2,'{$_SESSION['username']}')";

            $sql_insert_datarow_3 = "INSERT INTO leadership_management_main (School_ID,Activity_Number,Marks,Session_Name) VALUE ('{$_SESSION['school_id']}','6.8.3',$data3,'{$_SESSION['username']}')";

            $sql_insert_datarow_4 = "INSERT INTO leadership_management_main (School_ID,Activity_Number,Marks,Session_Name) VALUE ('{$_SESSION['school_id']}','6.8.4',$data4,'{$_SESSION['username']}')";
...
Table – 1.2.2.2</P>
  ...
  <tr class="active-row" >
    <td>6.8.1</td>
    <td> A systematic plan for internal evaluation is prepared, assigning duties 
according to aspects to be assessed, and implemented</td>
    <td><input type="number"  autocomplete="off" name="marks1" value="<?php echo $marks1; ?>" required ></td>
  </tr>

    <tr class="active-row" >
    <td>6.8.2</td>
    <td>   Internal self-assessment and external evaluation data are analyzed to 
identify the school’s strengths and weaknesses and feedback is provided to 
all stakeholders</td>
  ...
  <tr class="active-row" >
    <td>6.8.3</td>
    <td> Identified needs arising from school self-evaluation form the 
development agenda in the annual improvement programme</td>
    <td><input type="number"  autocomplete="off" name="marks3" value="<?php echo $marks3; ?>" required ></td>
  </tr>

    <tr class="active-row" >
    <td>6.8.4</td>
    <td>  Standard arrangements are followed for internal and external 
evaluation, records are maintained and agreed development points are 
implemented to bring about improvement</td>
