<?php  
    ...
    if(isset($_POST['submit'])){
        ...
        if ($data1 != "" && $data2 != "" && $data3 != ""  ){
            ...
            $sql_insert_datarow_1 = "INSERT INTO leadership_management_main (School_ID,Activity_Number,Marks,Session_Name) VALUE ('{$_SESSION['school_id']}','6.16.1',$data1,'{$_SESSION['username']}')";

            $sql_insert_datarow_2 = "INSERT INTO leadership_management_main (School_ID,Activity_Number,Marks,Session_Name) VALUE ('{$_SESSION['school_id']}','6.16.2',$data2,'{$_SESSION['username']}')";

            $sql_insert_datarow_3 = "INSERT INTO leadership_management_main (School_ID,Activity_Number,Marks,Session_Name) VALUE ('{$_SESSION['school_id']}','6.16.3',$data3,'{$_SESSION['username']}')";
...
$marks1 = "";
$sql = "SELECT  Marks FROM leadership_management_main WHERE Activity_Number ='6.16.1' && School_ID ='{$_SESSION['school_id']}' order by Leadership_Management_ID DESC LIMIT 1 ";
...
$marks2 = "";
$sql = "SELECT  Marks FROM leadership_management_main WHERE Activity_Number ='6.16.2' && School_ID ='{$_SESSION['school_id']}' order by Leadership_Management_ID DESC LIMIT 1 ";
$result = $con->query($sql);
...
$marks3 = "";
$sql = "SELECT  Marks FROM leadership_management_main WHERE Activity_Number ='6.16.3' && School_ID ='{$_SESSION['school_id']}' order by Leadership_Management_ID DESC  LIMIT 1 ";
$result = $con->query($sql);
...
to received letters</td>
    ...
    <?php $_SESSION["leadership_6_16"] = $total_marks; ?>
    <?php echo "Marks Total"."  ". $_SESSION["leadership_6_16"]; ?>
  </tr>
...
<a  style="float:right; color: black"; href=" leadership6.2.php" >Go to next page</a>
<a  style="float:left; color: black;" href=" leadership6.15.php" >Go to previous page</a>
